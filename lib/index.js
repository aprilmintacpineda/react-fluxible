    ...
    function ConnectedComponent(props) {
      ...
      this.render = function () {
        if (mapStatesToProps && definedMutations) {
          return _react.default.createElement(WrappedComponent, _extends({}, _this.props, mutations, _this.mappedStates));
        } else if (mapStatesToProps) {
          return _react.default.createElement(WrappedComponent, _extends({}, _this.props, _this.mappedStates));
        }
