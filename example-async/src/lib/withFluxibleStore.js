...
var _redefineStaticsJs = _interopRequireDefault(
  require('redefine-statics-js')
);
...
function withFluxibleStore(WrappedComponent, callback) {
  function ConnectedComponent(props) {
    ...
    this.componentWillUnmount = (0, _fluxibleJs.addObserver)(
      function () {
  ...
  ConnectedComponent.prototype =
    _react['default'].Component.prototype;
  ConnectedComponent.prototype.constructor = ConnectedComponent;
  (0, _redefineStaticsJs['default'])(
    ConnectedComponent,
    WrappedComponent
  );
